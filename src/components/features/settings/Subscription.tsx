  ...
  return (
    <div className="animate-in slide-in-from-right duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        {plans.map(plan => (
          <div key={plan.id} className={`relative bg-[var(--bg-card)] rounded-2xl p-6 border flex flex-col ${plan.popular ? 'border-[var(--primary)] ring-4 ring-indigo-50/50 dark:ring-indigo-900/40 shadow-xl' : 'border-[var(--border)] shadow-sm'}`}>
